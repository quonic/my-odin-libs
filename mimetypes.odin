...
mime_type_from_string :: proc(mime_string: string) -> MimeType {
	return transmute(MimeType)(mime_string)
}

// Searches for a MIME type by its string representation. Either exact match or partial match.
// Returns the found MIME types.
mime_find_string :: proc(
	mime_string: string,
	allocator := context.temp_allocator,
) -> (
	mime_types: [dynamic]MimeType,
) {
	for key, value in MimeTypes {
		if value == mime_string {
			append(&mime_types, key)
		}
		if strings.contains(value, mime_string) || strings.contains(string(key), mime_string) {
			append(&mime_types, key)
		}
	}
	return
...
MimeTypes: map[MimeType]string = {
	...
	"audio/vnd.blockfact.facta"                                                            = "vnd.blockfact.facta",
	...
	"vnd.blockfact.facti"                                                                  = "image/vnd.blockfact.facti",
	"vnd.clip"                                                                             = "image/vnd.clip",
	...
	"webp"                                                                                 = "image/webp",
	"wmf"                                                                                  = "image/wmf",
	"x-emf - DEPRECATED in favor of image/emf"                                             = "image/x-emf",
	"x-wmf - DEPRECATED in favor of image/wmf"                                             = "image/x-wmf",
	...
	"message/s-http"                                                                       = "s-http (OBSOLETE)",
	"message/sip"                                                                          = "sip",
	...
	"model/prc"                                                                            = "prc",
	"model/step"                                                                           = "step",
	"model/step+xml"                                                                       = "step+xml",
	"model/step+zip"                                                                       = "step+zip",
	"model/step-xml+zip"                                                                   = "step-xml+zip",
	"model/stl"                                                                            = "stl",
	"model/u3d"                                                                            = "u3d",
	"model/vnd.bary"                                                                       = "vnd.bary",
	"model/vnd.cld"                                                                        = "vnd.cld",
	...
	"model/vnd.pytha.pyox"                                                                 = "vnd.pytha.pyox",
	"model/vnd.rosette.annotated-data-model"                                               = "vnd.rosette.annotated-data-model",
	"model/vnd.sap.vds"                                                                    = "vnd.sap.vds",
	"model/vnd.usda"                                                                       = "vnd.usda",
	...
	"text/dns"                                                                             = "dns",
	"text/ecmascript"                                                                      = "ecmascript (OBSOLETED in favor of text/javascript)",
	...
	"text/vnd.exchangeable"                                                                = "vnd.exchangeable",
	"text/vnd.familysearch.gedcom"                                                         = "vnd.familysearch.gedcom",
	"text/vnd.ficlab.flt"                                                                  = "vnd.ficlab.flt",
	"text/vnd.fly"                                                                         = "vnd.fly",
	"text/vnd.fmi.flexstor"                                                                = "vnd.fmi.flexstor",
	"text/vnd.gml"                                                                         = "vnd.gml",
	"text/vnd.graphviz"                                                                    = "vnd.graphviz",
	"text/vnd.hans"                                                                        = "vnd.hans",
	...
	"video/jpeg2000-scl"                                                                   = "jpeg2000-scl",
	"video/jxsv"                                                                           = "jxsv",
	"video/lottie+json"                                                                    = "lottie+json",
	"video/matroska"                                                                       = "matroska",
	"video/matroska-3d"                                                                    = "matroska-3d",
	"video/mj2"                                                                            = "mj2",
	"video/MP1S"                                                                           = "MP1S",
	"video/MP2P"                                                                           = "MP2P",
	"video/MP2T"                                                                           = "MP2T",
	...
	"video/vc1"                                                                            = "vc1",
	"video/vc2"                                                                            = "vc2",
	"video/vnd.blockfact.factv"                                                            = "vnd.blockfact.factv",
	...
	"video/vnd.youtube.yt"                                                                 = "vnd.youtube.yt",
